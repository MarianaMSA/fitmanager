...
export function Toast({ msg, visible, type = 'success' }) {
  const isError = type === 'error'
  return (
    <div style={{
      position: 'fixed', bottom: 24, left: '50%', transform: 'translateX(-50%)',
      background: isError ? '#C0392B' : C.green, color: '#fff', fontSize: 13, padding: '10px 20px',
      borderRadius: 12, display: 'flex', alignItems: 'center', gap: 8,
      boxShadow: isError ? '0 4px 20px rgba(192,57,43,.35)' : '0 4px 20px rgba(29,158,117,.35)',
